...
for sample in range(args.start, args.end + 1):
    ...
    base_directory = "decfiles_b2dstar_np_070726/decfile" + str(sample)
    # Directory where the event data will be stored
    events_directory = "datafiles_b2dstar_np_070726/rootfile" + str(sample)
    ...
    command_template = "./run_dstarlnu2 -n 50000 -b anti-B0 -u {dec_file} -o {root_file} -s {seed}"
